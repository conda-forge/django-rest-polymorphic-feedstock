...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9226&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-rest-polymorphic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-rest-polymorphic` can be installed with:

```
conda install django-rest-polymorphic
```

It is possible to list all of the versions of `django-rest-polymorphic` available on your platform with:
